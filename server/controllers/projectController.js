...
export const createProject = async (req, res) => {
  try {
    ...
    //check if user had admin role in the workspace
  ...
  try {
    ...
    if (
      ...
      if (!project) {
        ...
        return res.status(403).json({
          message:
            "You don't have permissions to update project in this workspace",
        });
      }
    }
